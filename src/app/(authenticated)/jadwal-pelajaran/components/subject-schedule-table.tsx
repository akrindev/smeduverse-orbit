...
import {
	...
	useDeleteSubjectScheduleMutation,
...
export function SubjectScheduleTable({ onEdit }: SubjectScheduleTableProps) {
	const { data: schedules = [], isLoading, error } = useSubjectSchedulesQuery();
	const deleteMutation = useDeleteSubjectScheduleMutation();
		...
		<Card>
			<CardHeader className="flex flex-row justify-between items-center">
				<div>
					...
					<CardDescription>
						Daftar semua jadwal pelajaran yang terdaftar
					</CardDescription>
				</div>

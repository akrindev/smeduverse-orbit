...
export default function AssignmentRecapPage() {
	const { kelasajaruuid } = useParams<{ kelasajaruuid: string }>();
	...
	const {
		...
		isLoading,
		error,
	} = useAssignmentRecapQuery(kelasajaruuid);
			...
			<div className="flex flex-col h-full">
				...
				<Card>
					<CardHeader className="flex md:flex-row flex-col justify-between items-center">
						<div>
							<CardTitle>Rekap Tugas Kelas Ajar</CardTitle>
							<CardDescription>
					...
					<CardContent>
						{studentData && studentData.length > 0 ? (
							...
							<div className="flex flex-col justify-center items-center py-12">
								...
								<div className="text-muted-foreground">
									Tidak ada data rekap tugas untuk kelas ajar ini
								</div>
							</div>
						)}
					</CardContent>

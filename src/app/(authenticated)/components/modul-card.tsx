            ...
            <>
              ...
              <div className="text-xs">
                ...
                <div className="text-muted-foreground">
                    ...
                    try {
                      ...
                      if (dateValue) {
                        ...
                        if (!isNaN(parsedDate.getTime())) {
                          return format(parsedDate, "EEEE, PPP", { locale: localeId });
                        }
                      }
                  ...
                  })()} • {modul.latest_presence.start_time} - {modul.latest_presence.end_time}
                </div>
                <div className="flex flex-wrap gap-1 pt-1">
                  {(["h", "i", "s", "a", "b"] as const).map((k) => {
                    ...
                    return (
                      <Badge key={k} variant="outline" className={statusColors[k]}>
                        {k.toUpperCase()}: {count}
                      </Badge>
                    );
                  })}
